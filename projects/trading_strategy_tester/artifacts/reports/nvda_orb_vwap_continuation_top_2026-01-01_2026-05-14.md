...
- Reversal trades: `0`
- Win rate: `60.67%`
- Gross PnL per share: `20.0275`
- Average R: `0.0939`
- Median R: `0.4957`
- Max drawdown per share: `12.2500`
- Target exits: `43`
- Stop exits: `21`
- Session-close exits: `25`
...
- ORB + VWAP gross PnL per share: `20.0275`
- Buy-and-hold PnL per share: `35.9900`
- Strategy minus buy-and-hold: `-15.9625`
...
- Trade log CSV: `nvda_orb_vwap_continuation_top_trades_2026-01-01_2026-05-14.csv`
